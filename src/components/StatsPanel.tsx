...
const statStyles = [
  {
    color: "emerald",
    className: "border-emerald-300/35 bg-emerald-500/12",
    textClassName: "text-emerald-200",
  },
  {
    color: "violet",
    className: "border-violet-300/35 bg-violet-500/12",
    ...
    <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
      {stats.map((stat, index) => (
        ...
        >
          ...
          <p
            className={`mt-1 font-display text-3xl font-semibold ${statStyles[index].textClassName}`}
          >
            {stat.value}
          </p>
        </motion.div>
